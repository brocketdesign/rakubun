...
export const en: Translations = {
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        price: '$9',
        period: '/month',
        description: 'For creators ready to automate',
        features: [
          '30 articles/mo',
          '3 sites',
          '10 schedules',
  ...
  documentation: {
    ...
    apiSection: {
      title: 'API Reference',
      intro: 'Use the RakuBun REST API to programmatically manage your connected WordPress sites. All endpoints require authentication via your API key passed in the Authorization header.',
      baseUrl: 'Base URL',
      authentication: 'Authentication',
      authDescription: 'Include your API key in the Authorization header of every request: Authorization: Bearer YOUR_API_KEY',
      endpoints: [
        {
          title: 'List All Connected Sites',
          method: 'GET',
          path: '/api/v1/sites',
          description: 'Returns an array of all WordPress sites connected to your RakuBun account, including status, article counts, and sync information.',
        ...
        },
        {
          ...
          description: 'Returns detailed information about a specific connected site, including its full settings, connection status, and article generation stats.',
          responseExample: JSON.stringify({
            id: 'abc123',
            name: 'Tech Blog',
            url: 'techblog.com',
        ...
        },
        {
          ...
          description: 'Updates the settings for a specific site. You can send a partial settings object — only the provided fields will be updated.',
          responseExample: JSON.stringify({
            id: 'abc123',
            name: 'Tech Blog',
            settings: {
