...
const headlines = [
    "AIがブログ記事をサクッとお届け！",
    "らくぶんでAI任せ、ブログの自動更新はお手のもの！",
    "AIが書いて、らくぶんが投稿。あなたはただ見守るだけ",
    "AIとらくぶんで、ブログライフがさらに快適に！",
    "ブログ更新はAIにおまかせ！らくぶんで簡単投稿",
    "らくぶんでブログをらくらく自動化！AIが全部やります",
    "AIがブログを勝手に投稿、らくぶんで超お手軽！",
    "らくぶんとAIで、ブログの更新は指一本でOK！",
    "らくぶんでAIがブログを書く時代、もう手間いらず！",
